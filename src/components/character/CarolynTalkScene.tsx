...
export function CarolynTalkScene({ result, onBack, demoMode = false }: CarolynTalkSceneProps) {
  ...
  return (
    <article className="relative mx-auto h-[100svh] w-full max-w-[430px] overflow-hidden bg-gradient-to-b from-white via-rose-50 to-pink-100 text-zinc-950 shadow-[0_24px_70px_rgba(236,72,153,0.14)] sm:rounded-[38px] sm:border sm:border-pink-100">
      ...
      <section className="absolute inset-x-3 bottom-[58px] z-40 animate-carolyn-pop rounded-[26px] border border-white/80 bg-white/82 px-4 py-3 shadow-[0_18px_44px_rgba(236,72,153,0.14)] backdrop-blur-md">
      ...
      <div className="absolute inset-x-3 bottom-2 z-40 rounded-2xl border border-zinc-200/80 bg-white/86 px-3.5 py-2 shadow-[0_12px_30px_rgba(15,23,42,0.08)] backdrop-blur">
